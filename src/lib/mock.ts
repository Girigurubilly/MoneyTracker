...
export const accounts: Account[] = [
  ...
  { id: "hsbc-debit", name: "HSBC debit", nameZh: "匯豐扣帳卡", type: "debit", currency: "HKD", balance: 8200, includeInNetWorth: true, group: "cash", sortOrder: 4 },
  { id: "hsbc-visa", name: "HSBC Visa", nameZh: "匯豐 Visa", type: "credit", currency: "HKD", balance: -2846, includeInNetWorth: true, group: "credit", sortOrder: 0 },
...
export const recurring: Recurring[] = [
  { id: "r-salary", type: "income", label: "Salary", labelZh: "薪金", amount: 72000, currency: "HKD", accountId: "bochk", categoryId: "salary", frequency: "monthly", nextDate: "2026-09-28", chargedDay: 28 },
  { id: "r-mgmt", type: "expense", label: "Management fee", labelZh: "管理費", amount: 2180, currency: "HKD", accountId: "bochk", categoryId: "mgmt", frequency: "monthly", nextDate: "2026-10-01", chargedDay: 1, essential: true, living: true },
  { id: "r-mortgage-p", type: "transfer", label: "Mortgage principal", labelZh: "按揭本金", amount: 9600, currency: "HKD", accountId: "bochk", toAccountId: "mortgage", categoryId: "mortgage-p", frequency: "monthly", nextDate: "2026-10-01", chargedDay: 1, essential: true, living: true, countsAsExpense: true, splitWithId: "r-mortgage-i" },
  { id: "r-mortgage-i", type: "expense", label: "Mortgage interest", labelZh: "按揭利息", amount: 4980, currency: "HKD", accountId: "bochk", categoryId: "mortgage-i", frequency: "monthly", nextDate: "2026-10-01", chargedDay: 1, essential: true, living: true, splitWithId: "r-mortgage-p" },
  { id: "r-life", type: "expense", label: "Life insurance", labelZh: "人壽保險", amount: 1860, currency: "HKD", accountId: "hsbc-visa", categoryId: "insurance", frequency: "monthly", nextDate: "2026-10-05", chargedDay: 5, essential: true },
  { id: "r-mobile", type: "expense", label: "Mobile plan", labelZh: "流動電話", amount: 198, currency: "HKD", accountId: "hsbc-visa", categoryId: "internet", frequency: "monthly", nextDate: "2026-09-26", chargedDay: 26, essential: true, variable: true },
  { id: "r-mpf", type: "expense", label: "Voluntary MPF", labelZh: "自願性強積金", amount: 3000, currency: "HKD", accountId: "bochk", categoryId: "mpf-vol", frequency: "monthly", nextDate: "2026-09-28", chargedDay: 28 },
  { id: "r-travel", type: "transfer", label: "Travel fund", labelZh: "旅遊儲蓄", amount: 3500, currency: "HKD", accountId: "bochk", toAccountId: "hsb-save", frequency: "monthly", nextDate: "2026-09-28", chargedDay: 28 },
];
...
export const transactions: Transaction[] = [
  ...
  t({ id: "tx-mgmt", type: "expense", amount: 2180, currency: "HKD", accountId: "bochk", categoryId: "mgmt", date: "2026-09-01", payee: "Management", payeeZh: "管理費" }),
  t({ id: "tx-mp", type: "transfer", amount: 9600, currency: "HKD", accountId: "bochk", toAccountId: "mortgage", destAmount: 9600, categoryId: "mortgage-p", date: "2026-09-01", payee: "Mortgage principal", payeeZh: "按揭本金", countsAsExpense: true }),
  t({ id: "tx-mi", type: "expense", amount: 4980, currency: "HKD", accountId: "bochk", categoryId: "mortgage-i", date: "2026-09-01", payee: "Mortgage interest", payeeZh: "按揭利息" }),
  t({ id: "tx-life", type: "expense", amount: 1860, currency: "HKD", accountId: "hsbc-visa", categoryId: "insurance", date: "2026-09-05", payee: "Life insurance", payeeZh: "人壽保險" }),
  ...
  t({ id: "tx-coffee", type: "expense", amount: 48, currency: "HKD", accountId: "hsbc-visa", categoryId: "dining", date: "2026-09-05", payee: "Starbucks", payeeZh: "星巴克" }),
  t({ id: "tx-lunch", type: "expense", amount: 92, currency: "HKD", accountId: "octopus", categoryId: "dining", date: "2026-09-04", payee: "Cafe", payeeZh: "茶餐廳" }),
  t({ id: "tx-groc", type: "expense", amount: 420, currency: "HKD", accountId: "hsbc-visa", categoryId: "groceries", date: "2026-09-03", payee: "Wellcome", payeeZh: "惠康" }),
  t({ id: "tx-debit-groc", type: "expense", amount: 156, currency: "HKD", accountId: "hsbc-debit", categoryId: "groceries", date: "2026-09-04", payee: "ParknShop", payeeZh: "百佳" }),
  t({ id: "tx-mtr1", type: "expense", amount: 51.2, currency: "HKD", accountId: "octopus", categoryId: "mtr", date: "2026-09-05", payee: "MTR", payeeZh: "港鐵" }),
  t({ id: "tx-mtr2", type: "expense", amount: 18, currency: "HKD", accountId: "octopus", categoryId: "mtr", date: "2026-09-03", payee: "MTR", payeeZh: "港鐵" }),
  t({ id: "tx-ent", type: "expense", amount: 320, currency: "HKD", accountId: "hsbc-visa", categoryId: "entertainment", date: "2026-09-01", payee: "Cinema", payeeZh: "戲院" }),
