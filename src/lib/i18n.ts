...
export const messages = {
  en: {
    ...
    travel: {
      ...
      validUntil: "A trip stays available for 1 year after it ends, so later expenses can still be linked.",
      expired: "Expired",
      ended: "Ended",
      removeTrip: "Remove trip",
      confirmRemove: "Remove this trip? Linked expenses stay on the ledger, unlinked from the trip.",
    },
    cashflow: {
      ...
      outflow: "Outflow",
      net: "Net",
      fromRecurring: "Income and expense for each month, including scheduled items that have not posted yet.",
    },
    retirement: {
      title: "Retirement",
      ...
      spendAfter: "Monthly spend after retirement",
      saveNeeded: "Extra monthly saving needed",
      saveNeededHint:
        "How much extra to save each month before retirement so the post-retirement spend lasts to the expected lifespan.",
      noSalary: "Salary stops at retirement. Post-retirement income is annuities, 生果金, and one-offs only.",
      annuities: "Annuities",
      addAnnuity: "Add annuity",
      annuityHint: "Monthly payout from an annuity you already bought — from start age to end age.",
      oaa: "Old Age Allowance (生果金)",
      oaaHint: "Hong Kong Old Age Allowance. Default HK$1,620 / month from age 70, for life.",
      startAge: "From age",
      endAge: "To age",
      monthlyAmt: "Monthly amount",
      incomeNow: "Monthly income now",
      spendNow: "Monthly spend now",
      from12m: "Average of the last 12 months",
      saving12m: "Last 12 months’ average saving",
      targetHint:
        "After retirement there is no salary. Target monthly is the spending you want in retirement, in today’s HKD. Extra monthly saving is what you still need to set aside before then.",
    ...
    import: {
      ...
      btpHint: "Import a JSON snapshot or a Budget Tracker Pro file from your device. This replaces records stored in this browser.",
      btpDone: "Imported",
  ...
  "zh-HK": {
    ...
    travel: {
      ...
      validUntil: "旅程結束後仍可使用一年，之後的開支仍可連結到該旅程。",
      expired: "已過期",
      ended: "已結束",
      removeTrip: "移除旅程",
      confirmRemove: "移除此旅程？已連結的開支會保留，只是不再綁在這個旅程。",
    },
    cashflow: {
      title: "現金流預測",
      next6: "未來 6 個月",
      ...
      outflow: "流出",
      net: "淨額",
      fromRecurring: "按每月收入與開支計算，包括尚未到期的預定交易。",
    },
    retirement: {
      title: "退休",
      timeline: "個人時間線",
      ...
      target: "目標每月（今日港元）",
      spendAfter: "退休後每月開支",
      saveNeeded: "退休前需額外每月儲蓄",
      saveNeededHint: "為了達到退休後的每月開支，到預期終年之前，現在每月還要多儲多少。",
      noSalary: "退休後不再有薪金。退休後收入只計年金、生果金及一次性項目。",
      annuities: "年金",
      addAnnuity: "新增年金",
      annuityHint: "已買入年金的每月金額，以及由幾歲領到幾歲。",
      oaa: "高齡津貼（生果金）",
      oaaHint: "香港高齡津貼。預設由 70 歲起每月 $1,620，終身。",
      startAge: "由年齡",
      endAge: "至年齡",
      monthlyAmt: "每月金額",
      incomeNow: "現時每月收入",
      ...
      targetHint:
        "退休後沒有薪金。目標每月是你希望退休後的開支（今日港元）。額外每月儲蓄是退休前還要多儲的金額。",
      required: "所需資本",
      gap: "資金差距 / 盈餘",
      extra: "為達標每月需額外儲蓄",
      lasts: "資產可否用至預期終年",
    ...
    import: {
      ...
      btpHint: "從裝置匯入 JSON 備份或 Budget Tracker Pro 檔案。會取代此瀏覽器上的紀錄。",
      btpDone: "已匯入",
      btpFail: "無法讀取此檔案",
      replacing: "匯入中… 請稍候",
