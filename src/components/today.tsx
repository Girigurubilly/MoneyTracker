    ...
    <div className="flex min-h-[calc(100dvh-4.25rem)] flex-col lg:min-h-dvh">
      <header className="px-4 pb-2 pt-[max(0.9rem,env(safe-area-inset-top))]">
        <div className="flex items-end justify-between gap-2">
          <h1 className="whitespace-nowrap text-3xl font-semibold tracking-tight [text-wrap:nowrap]">
        ...
        <div className="mt-1 flex items-center justify-center">
          ...
          <button
            ...
            className={cn(
              "min-w-16 text-center text-sm font-medium",
              onThisMonth ? "text-faint" : "text-accent",
            )}
...
function TodayBody() {
  ...
  return (
    <div className="pb-10">
      ...
      <p className="px-5 pb-2 text-[11px] text-faint">{t.today.guidance}</p>
      ...
      <Link to="/budget" className="flex w-full items-center gap-3 px-5 py-3.5 text-left">
        <span className="relative">
          ...
          <span
            className={cn(
              ...
              ringTone === "expense" ? "text-expense" : ringTone === "watch" ? "text-watch" : "text-income",
            )}
          >
        ...
        <span className="text-right">
          <span className="block text-[15px] font-semibold tabular-nums">{money(used, "HKD")}</span>
