...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BuhSvoBR.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-Des7-i-O.js").then((n) => n.t),
...
var ROUTER_BASEPATH = "/MoneyTracker";
var SERVER_FN_BASE = "/MoneyTracker/_serverFn/";
